...
public class CW_Q1_3 extends JFrame{
    ...
    class Renderer implements GLEventListener, MouseListener, MouseMotionListener, KeyListener {
        ...
        public void init(GLAutoDrawable drawable) {
            ...
            createTexturedObject(gl, sphere2, 4, materialAmbient4, materialDiffuse4, materialSpecular4);
...
//			T.Ortho(-1, 1, -1, 1, -1, 1);  //Default
        ...
        public void createTexturedObject(GL3 gl, SObject object, int test, Vec4 materialAmbient, Vec4 materialDiffuse,
                                         Vec4 materialSpecular){
            // This function handles the texturing of the objects, and uses the textureArray, to increase the size of
            // the buffer, and bind the textures to the vertices.
            try {
                // Load the texture
            ...
            ShaderProg shaderproc = new ShaderProg(gl, "Text.vert", "Text.frag");
        ...
        public void createObject(GL3 gl, SObject object, int test, Vec4 materialAmbient, Vec4 materialDiffuse,
                                 Vec4 materialSpecular) {
        ...
        public void mouseDragged(MouseEvent e) {
            ...
            if ((e.getModifiers() & InputEvent.BUTTON3_MASK) != 0) {
                if((rx <= 90) && (rx >= -90)){
                    //ry += (x - xMouse) * 1;
                    rx -= (y - yMouse) * 1;
                    System.out.println("rx: " + rx + " ymouse: " + yMouse + " y :" + y);
                    //xMouse = x;
                    yMouse = y;
                    if(rx >= 90){
                        rx = 90;
